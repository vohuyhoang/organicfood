								...
								<div class="product-wrap mb-25 scroll-zoom">
									<div class="product-img">
										<a href="#"> <img class="default-img"
											...
											class="hover-img" src="assets/user/img/product/pro-1-1.jpg" alt="">
								...
								<div class="product-wrap mb-25 scroll-zoom">
									<div class="product-img">
										<a href="single-product.html"> <img class="default-img"
											...
											class="hover-img" src="assets/user/img/product/pro-2-1.jpg" alt="">
								...
								<div class="product-wrap mb-25 scroll-zoom">
									<div class="product-img">
										<a href="#"> <img class="default-img"
											...
											class="hover-img" src="assets/user/img/product/pro-3-1.jpg" alt="">
										</a> <span class="pink">-10%</span>
										<div class="product-action">
											<div class="pro-same-action pro-wishlist">
												<a title="Wishlist" href="#"><i class="pe-7s-like"></i></a>
								...
								<div class="product-wrap mb-25 scroll-zoom">
									<div class="product-img">
										<a href="#"> <img class="default-img"
											...
											class="hover-img" src="assets/user/img/product/pro-4-1.jpg" alt="">
										</a> <span class="purple">New</span>
										<div class="product-action">
											<div class="pro-same-action pro-wishlist">
												<a title="Wishlist" href="#"><i class="pe-7s-like"></i></a>
								...
								<div class="product-wrap mb-25 scroll-zoom">
									<div class="product-img">
										<a href="#"> <img class="default-img"
											...
											class="hover-img" src="assets/user/img/product/pro-5-1.jpg" alt="">
										</a> <span class="pink">-10%</span>
										<div class="product-action">
											<div class="pro-same-action pro-wishlist">
												<a title="Wishlist" href="#"><i class="pe-7s-like"></i></a>
								...
								<div class="product-wrap mb-25 scroll-zoom">
									<div class="product-img">
										<a href="#"> <img class="default-img"
											...
											class="hover-img" src="assets/user/img/product/pro-6-1.jpg" alt="">
										</a> <span class="purple">New</span>
										<div class="product-action">
											<div class="pro-same-action pro-wishlist">
												<a title="Wishlist" href="#"><i class="pe-7s-like"></i></a>
								...
								<div class="product-wrap mb-25 scroll-zoom">
									<div class="product-img">
										<a href="#"> <img class="default-img"
											...
											class="hover-img" src="assets/user/img/product/pro-6.jpg" alt="">
										</a> <span class="purple">New</span>
										<div class="product-action">
											<div class="pro-same-action pro-wishlist">
												<a title="Wishlist" href="#"><i class="pe-7s-like"></i></a>
