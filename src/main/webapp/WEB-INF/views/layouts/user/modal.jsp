					...
					<div class="col-md-5 col-sm-12 col-xs-12">
						<div class="tab-content quickview-big-img">
							<div id="pro-1" class="tab-pane fade show active">
								<img src="assets/user/img/product/quickview-l1.jpg" alt="">
							</div>
							<div id="pro-2" class="tab-pane fade">
								<img src="assets/user/img/product/quickview-l2.jpg" alt="">
							</div>
							<div id="pro-3" class="tab-pane fade">
								<img src="assets/user/img/product/quickview-l3.jpg" alt="">
							</div>
						...
						<div class="quickview-wrap mt-15">
							<div class="quickview-slide-active owl-carousel nav nav-style-1"
								...
								<a class="active" data-toggle="tab" href="#pro-1"><img
									src="assets/user/img/product/quickview-s1.jpg" alt=""></a> <a
									data-toggle="tab" href="#pro-2"><img
									src="assets/user/img/product/quickview-s2.jpg" alt=""></a> <a
									data-toggle="tab" href="#pro-3"><img
									src="assets/user/img/product/quickview-s3.jpg" alt=""></a> <a
									data-toggle="tab" href="#pro-4"><img
									src="assets/user/img/product/quickview-s2.jpg" alt=""></a>
							</div>
						</div>
					</div>
