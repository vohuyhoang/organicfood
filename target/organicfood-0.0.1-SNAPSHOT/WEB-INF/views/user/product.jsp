											...
											<div class="product-wrap">
												<div class="product-img">
													<a href="#"> <img class="default-img"
														src="assets/user/img/product/pro-1.jpg" alt=""> <img
														class="hover-img"
														src="assets/user/img/product/pro-1-1.jpg" alt="">
													</a> <span class="pink">-10%</span>
												</div>
											</div>
										</div>
											...
											<div class="product-wrap">
												<div class="product-img">
													<a href="#"> <img class="default-img"
														src="assets/user/img/product/pro-2.jpg" alt=""> <img
														class="hover-img"
														src="assets/user/img/product/pro-2-1.jpg" alt="">
													</a> <span class="purple">New</span>
												</div>
											</div>
										</div>
											...
											<div class="product-wrap">
												<div class="product-img">
													<a href="#"> <img class="default-img"
														src="assets/user/img/product/pro-3.jpg" alt=""> <img
														class="hover-img"
														src="assets/user/img/product/pro-3-1.jpg" alt="">
													</a> <span class="pink">-20%</span>
												</div>
											</div>
										</div>
										<div class="col-xl-8 col-lg-7 col-md-7 col-sm-6">
											<div class="shop-list-content">
												...
												<div class="product-list-price">
													<span>$ 30.00</span> <span class="old">$ 50.00</span>
												</div>
												<div class="rating-review">
													<div class="product-list-rating">
														<i class="fa fa-star-o yellow"></i> <i
											...
											<div class="product-wrap">
												<div class="product-img">
													<a href="#"> <img class="default-img"
														src="assets/user/img/product/pro-7.jpg" alt=""> <img
														class="hover-img"
														src="assets/user/img/product/pro-4-1.jpg" alt="">
													</a> <span class="purple">New</span>
												</div>
											</div>
										</div>
								...
								<ul>
									<li>
										<div class="sidebar-widget-list-left">
											<input type="checkbox"> <a href="#">On Sale <span>4</span>
						...
						<div class="sidebar-widget mt-40">
							...
							<div class="sidebar-widget-list mt-20">
								<ul>
									...
									<li>
										<div class="sidebar-widget-list-left">
											<input type="checkbox" value=""> <a href="#">SM</a> <span
												class="checkmark"></span>
										</div>
									</li>
									<li>
